...
public class PersonServiceServiceLocator extends org.apache.axis.client.Service implements com.lavanya.gudimella.service.PersonServiceService {
    ...
    private java.lang.String PersonService_address = "http://localhost:8080/SOAP-WebService-Person/services/PersonService";
    ...
    public com.lavanya.gudimella.service.PersonService getPersonService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lavanya.gudimella.service.PersonServiceSoapBindingStub _stub = new com.lavanya.gudimella.service.PersonServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lavanya.gudimella.service.PersonService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lavanya.gudimella.service.PersonServiceSoapBindingStub _stub = new com.lavanya.gudimella.service.PersonServiceSoapBindingStub(new java.net.URL(PersonService_address), this);
                _stub.setPortName(getPersonServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.gudimella.lavanya.com", "PersonServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.gudimella.lavanya.com", "PersonService"));
        }
